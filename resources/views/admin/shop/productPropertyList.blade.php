...
@section('title', '| Список свойств товаров')
@section('content')
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Список свойств товаров
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    ...
                                    @endif
                                    <p class="card-text">
                                        <a href="{{ route('admin.product-properties.create') }}" class="btn btn-social btn-block mb-1 btn-vimeo" title="Добавить свойство"><span class="la la-plus"></span> Добавить свойство</a>
                                    </p>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div class="btn-group" role="group" aria-label="First Group">
                                                        <a href="{{ route('admin.product-properties.edit', $item) }}" class="btn btn-icon btn-success text-white" title="Редактировать"><i class="la la-edit"></i></a>
                                                        {!! Form::open(['method' => 'DELETE','route' => ['admin.product-properties.destroy', $item]]) !!}
                                                        {!! Form::submit('Удалить', ['class' => 'btn btn-icon btn-danger text-white', 'onclick'=> 'return confirm(\'Вы действительно хотите удалить данное свойство? У всех товаров будет удалено данное свойство, операция не возвратная.\')']) !!}
                                                        {!! Form::close() !!}
