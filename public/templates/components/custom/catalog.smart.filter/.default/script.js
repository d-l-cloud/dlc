			...
			$.get(
				...
				function (data) {
					var $html = $(data),
						...
						$productFilters = $html.find('.js-product-filters'),
						$btnShowMore = $html.find('.js-btn-show-more'),
						$pagination = $html.find('.js-pagination');

					$('.js-products-in-col').html($productsInCol.html());
					$('.js-products-in-row').html($productsInRow.html());
					
					$('.js-product-filters').html($productFilters.html());

					if ($btnShowMore.length) {
						$('.js-btn-show-more').html($btnShowMore.html()).show();
					} else {
