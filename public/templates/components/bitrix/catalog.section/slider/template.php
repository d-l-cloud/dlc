...
<div class="hits-slider additional-slider"
     data-infinity="<?=($bInfinity) ? '1' : '0'?>"
     data-variable-width="<?=($bVariableWidth) ? '1' : '0'?>" data-compare="<?=($arParams['IS_COMPARE_LIST'] == 'Y') ? '1' : '0'?>">
    <?
    if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS'])) {
        ...
        foreach ($arResult['ITEMS'] as $item) { ?>
            ...
            $APPLICATION->IncludeComponent(
                ...
                [
                    'BLOCK' => 'SLIDER',
                    'IS_COMPARE_LIST' => ($arParams['IS_COMPARE_LIST'] == 'Y') ? 'Y' : 'N',
